...
function renderHome() {
  ...
  const trackedCount = visibleProducts.length;
    ...
    <section class="hero">
      <div class="container hero-grid">
        <div>
          ...
          <h1>
            Know when a hardware wallet is
        ...
        <div class="hero-card">
          ...
          <div class="hero-card-text">
            We turn raw wallet prices into a simple
            purchase signal.
          </div>
      ...
      <div class="container">
        <div class="section-header">
          <div>
            ...
            <p>
              Compare current prices and see whether
          ...
          <div class="radar-grid">
            <div>
              ...
              <div class="radar-text">
                A cheap-looking price isn't necessarily
                a good deal. CryptoWalletRadar combines
                today's price with tracked history to
                help answer the question:
                <strong>buy now or wait?</strong>
              </div>
            </div>
      ...
      <div class="container">
        <div class="section-header">
          <div>
            ...
            <p>
              Simple information designed to make the
        ...
        <div class="steps">
          <div class="step">
            ...
            <p>
              We collect current wallet prices and
              keep a record of historical observations.
            </p>
          </div>
          ...
          <div class="step">
            ...
            <p>
              Today's price is compared with the
              prices we've already tracked.
            </p>
          </div>
          ...
          <div class="step">
            ...
            <p>
              Deal Score gives you a quick signal about
              how attractive the current price looks.
            </p>
          </div>
        </div>
      </div>
...
async function handleRequest(req, res) {
  ...
  if (
    ...
    sendHtml(res, 200, renderComparePage());
    return;
  }
  ...
  if (
    ...
    sendHtml(res, 200, renderHistoryPage());
    return;
  }
  ...
  if (
    ...
    if (
      ...
      sendHtml(
        ...
        400,
        renderPage(
          "Invalid Alert – CryptoWalletRadar",
          `
            <section class="page">
              <div class="container">
                <div class="alert-box">
                  ...
                  <p class="page-intro">
                    Please provide a wallet, target price
  ...
  if (
    ...
    sendJson(res, 200, {
      ok: true,
      service: "cryptowalletradar",
      products: products.length,
      trezorApiConfigured:
        Boolean(TREZOR_API_KEY),
    });
    return;
  }
...
server.listen(PORT, () => {
  console.log(
    `CryptoWalletRadar listening on port ${PORT}`
  );
